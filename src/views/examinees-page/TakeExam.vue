<template>
  <div>
    ...
    <b-card class="card w-50 align-center" v-show="helloShow">
      <h3>Hello there!</h3>
      <p>
        Your participation for this test is highly appreciated. Kindly click
        start to proceed to the test questions
      </p>
      <p><em>By clicking Start button TIMER will automatically start.</em></p>
      <b-button id="show-btn" @click="start()" variant="danger">
        Start
      </b-button>
    </b-card>
    <!-- Timer  -->
    ...
    <b-card v-show="formShow">
          ...
          <div>
            <b-form @submit.prevent="validateForm">
              <b-form-group>
                ...
                <div>
                  <span style="display: none" :ref="examQuestionnaire.id"
                    ><b>*</b></span
                  >
                  <b-form-radio-group
                    id="radio-group-2"
      ...
      <b-button type="submit" variant="danger" @click="submitExam">
        Submit
      </b-button>
      <!-- <b-button
        type="submit"
...
export default {
  ...
  methods: {
    ...
    async submitExam() {
      ...
      const ansIds = Object.entries(this.answers).map((ans) =>
        parseInt(ans[0])
      );
      ids.forEach((id) => {
